...
\begin{landscape}
	\begin{center}
		\begin{tikzpicture}[
				node distance=0.6cm,
				startstop/.style={rectangle, rounded corners, draw=brandblue, fill=lightblue!20, minimum width=3.5cm, minimum height=1cm, font=\bfseries\small},
				process/.style={rectangle, rounded corners, draw=mediumgray, fill=softgray, minimum width=3.2cm, minimum height=0.9cm, font=\bfseries\small},
				card/.style={rectangle, rounded corners, draw=accentblue, fill=lightblue!30, minimum width=3cm, minimum height=0.85cm, font=\bfseries\small},
				arrow/.style={thick,->,>=stealth, draw=brandblue}
			]
			...
			\node (card1) [card, below=1cm of display, xshift=-6cm] {\faAppleAlt\ Kost and Nutrition};
			\node (card2) [card, below=1cm of display, xshift=-2cm] {\faBrain\ Mindset};
			\node (card3) [card, below=1cm of display, xshift=2cm] {\faMicroscope\ Knowledge and Research};
			\node (card4) [card, below=1cm of display, xshift=6cm] {\faDumbbell\ Weekly Workouts};
			...
			\node (toggle5) [process, below=1.2cm of card5] {\faToggleOn\ Toggle On/Off};

			\node (validate) [process, below=2.5cm of card3, xshift=-4cm] {\faCheck\ Validate Selection};

			\node (warning) [process, right=3cm of validate] {\faExclamationTriangle\ Select at least 1};

			\node (email) [process, below=1.8cm of validate] {\faAt\ Enter Email};
			...
			\draw[arrow, dashed] (warning) -- ++(0,2.5cm) -| (display);
