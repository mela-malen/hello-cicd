...
\begin{landscape}
	\begin{center}
		\begin{tikzpicture}[
				node distance=0.7cm,
				startstop/.style={rounded rectangle, draw=brandblue, fill=lightblue!20, minimum width=3cm, minimum height=0.85cm, font=\bfseries\small},
				process/.style={rounded rectangle, draw=mediumgray, fill=softgray, minimum width=3cm, minimum height=0.85cm, font=\bfseries\small},
				card/.style={rounded rectangle, draw=accentblue, fill=lightblue!30, minimum width=2.8cm, minimum height=0.85cm, font=\bfseries\small},
				arrow/.style={thick,->,>=stealth, draw=brandblue}
			]
			...
			\node (toggle1) [process, below=1.2cm of card1] {\faToggleOn\ Toggle On/Off};
			\node (toggle2) [process, below=1.2cm of card2] {\faToggleOn\ Toggle On/Off};
			\node (toggle3) [process, below=1.2cm of card3] {\faToggleOn\ Toggle On/Off};
			\node (toggle4) [process, below=1.2cm of card4] {\faToggleOn\ Toggle On/Off};
			\node (toggle5) [process, below=1.5cm of card5] {\faToggleOn\ Toggle On/Off};

			\node (validate) [process, below=2.5cm of display, xshift=-1.2cm] {\faCheck\ Validate Selection};

			\node (warning) [process, right=3.5cm of validate] {\faExclamationTriangle\ Select at least 1};

			\node (email) [process, below=1.8cm of validate, xshift=-1.2cm] {\faAt\ Enter Email};
			...
			\draw[arrow, dashed] (warning) -- ++(0,1.8cm) -| (display);
