...
\begin{landscape}
	\begin{center}
		\begin{tikzpicture}[
			...
			\node (card1) [card, below=1.2cm of display, xshift=-7cm] {\faAppleAlt\ Kost and Nutrition};
			\node (card2) [card, below=1.2cm of display, xshift=-2.3cm] {\faBrain\ Mindset};
			\node (card3) [card, below=1.2cm of display, xshift=2.3cm] {\faMicroscope\ Knowledge and Research};
			\node (card4) [card, below=1.2cm of display, xshift=7cm] {\faDumbbell\ Weekly Workouts};
			...
			\node (validate) [process, below=3cm of display, xshift=-1.5cm] {\faCheck\ Validate Selection};

			\node (warning) [process, right=4.5cm of validate] {\faExclamationTriangle\ Select at least 1};
