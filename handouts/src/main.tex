...
\begin{landscape}
	\begin{center}
		\begin{tikzpicture}[
			...
			\node (display) [process, below=0.45cm of start] {\faList\ Cards};

			\node (card1) [card, below=0.45cm of display, xshift=-6.5cm] {\faAppleAlt\ Kost/Nutr};
			\node (card2) [card, below=0.45cm of display, xshift=-2.2cm] {\faBrain\ Mindset};
			\node (card3) [card, below=0.45cm of display, xshift=2.2cm] {\faMicroscope\ Knowledge};
			\node (card4) [card, below=0.45cm of display, xshift=6.5cm] {\faDumbbell\ Workouts};
			\node (card5) [card, below=1cm of display, xshift=0cm] {\faRobot\ AI Training};

			\node (toggle1) [process, below=0.45cm of card1] {\faToggleOn\ Toggle};
			\node (toggle2) [process, below=0.45cm of card2] {\faToggleOn\ Toggle};
			\node (toggle3) [process, below=0.45cm of card3] {\faToggleOn\ Toggle};
			\node (toggle4) [process, below=0.45cm of card4] {\faToggleOn\ Toggle};
			\node (toggle5) [process, below=0.45cm of card5] {\faToggleOn\ Toggle};

			\node (validate) [process, below=1cm of card3, xshift=-5cm] {\faCheck\ Validate};

			\node (warning) [process, right=3.5cm of validate] {\faExclamationTriangle\ Select 1+};

			\node (email) [process, below=0.7cm of validate] {\faAt\ Email};

			\node (submit) [process, below=0.45cm of email] {\faPaperPlane\ Submit};

			\node (success) [startstop, below=0.45cm of submit] {\faSmile\ Welcome};
			...
			\draw[arrow, dashed] (warning) -- ++(0,1cm) -| (display);
