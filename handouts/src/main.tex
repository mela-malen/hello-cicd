...
\begin{landscape}
	\begin{center}
		\begin{tikzpicture}[
				node distance=0.4cm,
				startstop/.style={rectangle, rounded corners, draw=brandblue, fill=lightblue!20, minimum width=2.2cm, minimum height=0.5cm, font=\bfseries\tiny},
				process/.style={rectangle, rounded corners, draw=mediumgray, fill=softgray, minimum width=2cm, minimum height=0.45cm, font=\bfseries\tiny},
				card/.style={rectangle, rounded corners, draw=accentblue, fill=lightblue!30, minimum width=1.8cm, minimum height=0.45cm, font=\bfseries\tiny},
				arrow/.style={thick,->,>=stealth, draw=brandblue}
			]
			...
			\node (card1) [card, below=0.5cm of display, xshift=-4.5cm] {\faAppleAlt\ Kost/Nutr};
			\node (card2) [card, below=0.5cm of display, xshift=-1.5cm] {\faBrain\ Mindset};
			\node (card3) [card, below=0.5cm of display, xshift=1.5cm] {\faMicroscope\ Knowledge};
			\node (card4) [card, below=0.5cm of display, xshift=4.5cm] {\faDumbbell\ Workouts};
			...
			\node (validate) [process, below=1.2cm of card3, xshift=-3.5cm] {\faCheck\ Validate};

			\node (warning) [process, right=2.5cm of validate] {\faExclamationTriangle\ Select 1+};

			\node (email) [process, below=0.8cm of validate] {\faAt\ Email};

			\node (submit) [process, below=0.5cm of email] {\faPaperPlane\ Submit};

			\node (success) [startstop, below=0.5cm of submit] {\faSmile\ Welcome};
			...
			\draw[arrow, dashed] (warning) -- ++(0,1.2cm) -| (display);
